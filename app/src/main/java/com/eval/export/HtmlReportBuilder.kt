...
object HtmlReportBuilder {
     ...
     */
    fun convertMarkdownToHtml(serviceName: String, markdown: String, uiState: GameUiState, appVersion: String): String {
        ...
        val isWhiteToMove = uiState.currentBoard.getTurn() == PieceColor.WHITE
