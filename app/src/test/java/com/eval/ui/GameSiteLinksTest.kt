...
class GameSiteLinksTest {
    @Test fun web_hosts_are_case_insensitive_and_support_real_subdomains() {
        ...
        assertEquals("chess.com", gameSiteHost("https://www.chess.com/game/live/123"))
        assertEquals("chess.com", gameSiteHost("http://chess.com/game/live/123"))
    }

    @Test fun invalid_schemes_and_lookalike_hosts_are_not_game_links() {
        listOf("lichess.org/abc", "javascript:lichess.org", "ftp://chess.com/123",
            "https://lichess.org.example.com/abc", "https://example.com/chess.com",
            "https://chess.com@elsewhere.example/123", "https://someone@lichess.org/abc",
            "https://lichess.org/a b", "//chess.com/123", "?").forEach {
