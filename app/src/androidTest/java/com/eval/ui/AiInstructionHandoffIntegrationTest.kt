...
class AiInstructionHandoffIntegrationTest {
    ...
    private fun send(data: AiReportContext, instructions: String = "<prompt>@FEN@ @COLOR@ @SERVER@ @PLAYER@ @PGN@</prompt><open>@BOARD@</open>"): String {
    ...
    @Test fun position_context_tracks_white_and_black_to_move() {
        ...
        for (color in listOf("White", "Black")) {
            ...
            assertTrue(payload.startsWith("<prompt>"))
